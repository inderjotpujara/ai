...
import { EvalsTab } from './evals-tab.tsx';
...
/** The six Ops tabs. `enum` per this repo's enum-over-union convention. */
export enum OpsTab {
  Overview = 'overview',
  Jobs = 'jobs',
  Triggers = 'triggers',
