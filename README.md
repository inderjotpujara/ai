...
> already a first-class run root). The builders/library screens,
> cross-invocation persistence,
> and browser voice remain Phases 5–8. Next: **Slice 30b Phase 5**.
...
> trace waterfall), and 4 (Crews & Workflows browse/run/watch) have
> landed** — this is
> still a **partial-slice** landing (Phases 5–8 remain; the Slice-30b
...
> owns rich/interruptible voice via real `getUserMedia` AEC. See
