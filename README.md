...
> scaffold), 2 (streaming chat + live rail), and 3 (Runs history + live
> trace waterfall) have landed** — this is
> still a **partial-slice** landing (Phases 4–8 remain; the Slice-30b
