...
> (voice/streaming) — **Slices 23/24/25 remain held** on the `ai@7` provider
...
| **Next (product line)** | Toward a local **n8n × CrewAI**: **F** voice in/out · streaming CLI (**Slice 29**) → TUI/local web UI; **E** automate (always-on daemon + secure remote access, **Slice 24**; scheduled/triggered agents, 25) — held on the `ai@7` provider blocker (Slices 23/24/25); Codex heavy-lifting backup (Slice 22) deferred to the very end (Slice 38) | Planned |
