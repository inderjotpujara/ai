...
> Ollama). Next: **Slice 24** (always-on daemon + secure remote access),
> now unblocked on the dependency line. See
...
> (`ollama-ai-provider-v2@4`, `typescript@6`), unblocking the Slice 24
> daemon line; see the slice table below. **Phase 2**
...
| **Next (product line)** | Toward a local **n8n × CrewAI**: **Slice 30b is fully shipped** (all 8 phases — dictation-only voice; barge-in remains explicit future scope, not debt); **Slice 23** (AI SDK v6→v7 upgrade) ✅ **shipped** (2026-07-19), clearing the dependency-line hold; **E** automate (always-on daemon + secure remote access, **Slice 24**; scheduled/triggered agents, 25) — now unblocked; Codex heavy-lifting backup (Slice 22) deferred to the very end (Slice 38) | Planned |
